...
function sparkling_scripts() {
  ...
  /*
    ...
    Diligent search specific dependencies

  */
  
  // Shared ones
  wp_enqueue_script('ds-ajax-calls', get_template_directory_uri().'/added/js/ajax-calls.js', array('jquery'), true);
  wp_enqueue_script('ds-graphical-node-tools', get_template_directory_uri().'/added/js/graphical-node-tools.js', array('jquery'), true);

  
  /*
    Form
  */
  wp_enqueue_style( 'ds-form-css', get_template_directory_uri() . '/added/css/form.css' );
  wp_enqueue_script('ds-form-template', get_template_directory_uri().'/added/template-controller/form-renderer.js', array('jquery'), true);
  wp_enqueue_script('ds-form-injection', get_template_directory_uri().'/added/js/form-html-generation.js', array('jquery', 'ds-form-template'), true);
  wp_enqueue_script('ds-form-tools', get_template_directory_uri().'/added/js/form-tools.js', array('jquery', 'ds-form-injection'), true);


  /*
    Editor dependencies
  */
  wp_enqueue_style( 'ds-editor-css', get_template_directory_uri() . '/added/css/editor.css' );
  wp_enqueue_script('ds-editor-d3', get_template_directory_uri().'/added/js/lib/d3.v3.min.js', array('jquery'), true);
  wp_enqueue_script('ds-editor-dagred3', get_template_directory_uri().'/added/js/lib/dagre-d3.min.js', array('jquery', 'ds-editor-d3'), true);
  wp_enqueue_script('ds-editor-tree', get_template_directory_uri().'/added/js/decision-tree.js', array('jquery', 'ds-editor-dagred3'), true);
  wp_register_style('jquery-ui-styles','http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/themes/base/jquery-ui.css' );
  wp_enqueue_style('jquery-ui-styles' );

  /*
    Editor template controllers
  */
  wp_enqueue_script('ds-editor-country-modal', get_template_directory_uri().'/added/template-controller/data-modal/country-modal.js', array('jquery'), true);
  wp_enqueue_script('ds-editor-work-modal', get_template_directory_uri().'/added/template-controller/data-modal/work-modal.js', array('jquery'), true);
  wp_enqueue_script('ds-editor-user-input-modal', get_template_directory_uri().'/added/template-controller/data-modal/user-input-modal.js', array('jquery'), true);
  wp_enqueue_script('ds-editor-ref-value-modal', get_template_directory_uri().'/added/template-controller/data-modal/ref-value-modal.js', array('jquery'), true);
  wp_enqueue_script('ds-editor-question-modal', get_template_directory_uri().'/added/template-controller/data-modal/question-modal.js', array('jquery', 'jquery-ui-autocomplete'), true);
  wp_enqueue_script('ds-editor-result-modal', get_template_directory_uri().'/added/template-controller/data-modal/result-modal.js', array('jquery'), true);
  wp_enqueue_script('ds-editor-data-block-modal', get_template_directory_uri().'/added/template-controller/data-modal/block-modal.js', array('jquery'), true);
  wp_enqueue_script('ds-editor-template', get_template_directory_uri().'/added/template-controller/data-editor.js', array('jquery'), true);

  /*
    Editor decision tree
  */
  wp_enqueue_script('ds-editor-graph-editor', get_template_directory_uri().'/added/template-controller/graph-editor.js', array('jquery'), true);
  wp_enqueue_script('ds-editor-graph-node-modal', get_template_directory_uri().'/added/template-controller/graph-modal/node-config-modal.js', array('jquery'), true);

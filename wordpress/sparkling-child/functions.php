...
function diligentSearch_enqueue_scripts(){
  ...
  */
  ...
  wp_enqueue_script('editor-tree', get_stylesheet_directory_uri().'/js/decision-tree.js', array('jquery', 'editor-dagred3'), true);
  ...
  wp_enqueue_script('editor-graph-editor', get_stylesheet_directory_uri().'/template-controller/graph-editor.js', array('jquery'), true);
  wp_enqueue_script('editor-graph-node-modal', get_stylesheet_directory_uri().'/template-controller/graph-modal/node-config-modal.js', array('jquery'), true);
}
